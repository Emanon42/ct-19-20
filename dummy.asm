...
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t9, $s7, $t8]
# if ast.If@3feba861
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t9, $s7, $t8]
addi $t8, $fp, -116
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t9, $s7]
...
b _if5_end
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t8, $t9, $s7]
_if6_else:    # else
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t8, $t9, $s7]
# no local var detected
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t8, $t9, $s7]
...
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t8, $t9, $s7]
addi $s7, $fp, -112
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t8, $t9]
addi $t9, $fp, -104
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6, $t8]
lw $t8, 0($t9)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $s6]
...
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5]
sw $t9 0($s7)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s6]
# assign ast.Assign@723279cf
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s6, $s7, $t9]
addi $t9, $fp, -104
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s6, $s7]
addi $s7, $fp, -108
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s6]
lw $s6, 0($s7)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8]
sw $s6 0($t9)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s7]
# assign ast.Assign@10f87f48
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s7, $t9, $s6]
addi $s6, $fp, -108
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s7, $t9]
addi $t9, $fp, -112
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $s7]
lw $s7, 0($t9)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8]
sw $s7 0($s6)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9]
_if5_end:    nop
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s6, $s7]
# exprStmt ast.ExprStmt@b4c966a
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s6, $s7]
addi $s7, $fp, -112
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s6]
lw $s6, 0($s7)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9]
move $a0, $s6
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s7]
# print_i($a0)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s7, $s6]
li $v0, 1
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s7, $s6]
syscall
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t8, $t9, $s7, $s6]
...
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5]
sw $t8 0($s6)
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t9, $s7]
b _while3_start
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t9, $s7, $s6, $t8]
_while4_end:    nop
# free regs: [$t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $s0, $s1, $s2, $s3, $s4, $s5, $t9, $s7, $s6, $t8]
